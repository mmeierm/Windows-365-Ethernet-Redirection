 ...
 */
/* Compiler settings for SocksOverRDPPlugin.idl:
...
#ifndef __SocksOverRDPPlugin_i_h__
#define __SocksOverRDPPlugin_i_h__
...
#ifndef __SocksOverRDPPluginLib_LIBRARY_DEFINED__
#define __SocksOverRDPPluginLib_LIBRARY_DEFINED__

/* library SocksOverRDPPluginLib */
/* [custom][version][uuid] */ 


EXTERN_C const IID LIBID_SocksOverRDPPluginLib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("61715a27-63a8-4dc1-9857-83eb00fb60a3")
CompReg;
#endif
#endif /* __SocksOverRDPPluginLib_LIBRARY_DEFINED__ */
